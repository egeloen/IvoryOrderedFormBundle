...
``` bash
$ git clone git@github.com:your-name/IvoryOrderedFormBundle.git
...
[PHPUnit](http://phpunit.de/) and the doc is in the markdown format in the `README` file.
...
``` bash
$ git remote add upstream git@github.com:egeloen/IvoryOrderedFormBundle.git
